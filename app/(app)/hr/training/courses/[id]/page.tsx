...
import { getCourseMaterialSignedUrl } from '@/lib/utils/course-material-upload';
...
import type { AssignTrainingResult, Branch, Course, CourseMaterial, Department, EmployeeTraining } from '@/types';
    ...
    <div className="mx-auto max-w-4xl space-y-6 p-6 lg:p-8">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3">
          <Button variant="ghost" size="icon" onClick={() => router.push('/hr/training')}>
        ...
        <div className="flex items-center gap-2 sm:shrink-0">
          ...
          {canManage && (
            <>
              <Link href={`/hr/training/courses/${course.id}/edit`}>
