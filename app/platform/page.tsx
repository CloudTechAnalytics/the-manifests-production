...
export default function PlatformDashboardPage() {
  ...
  const tenancyKpis = [
    ...
    },
    {
      ...
      // click away. Rendered with the same serif/text-3xl style as
      // every other KPI here — no isCurrency font override.
      label: 'MRR',
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-2">
          <Button asChild variant="outline">
            <Link href="/platform/audit-logs">Audit Logs</Link>
          </Button>
          <Button asChild>
