...
import { ShipmentStatusDonut } from '@/shared/components/dashboard/shipment-status-donut';
import { RevenueTrendChart } from '@/shared/components/dashboard/revenue-trend-chart';
...
import type {
  ...
  RevenueTrendPoint,
  TopCustomerByVolume,
} from '@/shared/hooks/use-dashboard-data';
