...
import { CONTACT_EMAIL, CONTACT_PHONE, CONTACT_PHONE_HREF } from '@/shared/lib/contact';
...
export function LandingPage() {
  return (
    <div className="min-h-screen bg-background text-foreground">
      {/* ---------------------------------------------------------------- */}
      {/* Nav — the one interactive part of this page (scroll-aware
          backdrop + mobile sheet), split out so the rest below can be
        ...
        <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 items-center gap-16 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          <div className="animate-fade-up">
            ...
            <p className="mt-4 text-sm text-sidebar-muted">
              ...
              <Link to="/login" className="font-medium text-sidebar-accent hover:underline">
                Sign in
              </Link>
            </p>
          </div>
