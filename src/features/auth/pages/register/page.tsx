...
import { registerSchema, REGISTER_FORM_DEFAULTS, type RegisterFormValues } from '@/shared/lib/register-schema';
import { useRegisterWizard } from '@/shared/lib/register-wizard';
