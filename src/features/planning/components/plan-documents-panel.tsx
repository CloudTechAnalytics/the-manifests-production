...
interface PlanDocumentsPanelProps {
  planId: string;
  branchId: string;
}
...
export function PlanDocumentsPanel({ planId, branchId }: PlanDocumentsPanelProps) {
    ...
    <Card>
      ...
      <CardContent className="px-4 pb-4 pt-0">
        {loading ? (
          ...
          <EmptyState icon={FileText} title="No documents yet" message="Upload files related to this plan." compact />
        ) : (
