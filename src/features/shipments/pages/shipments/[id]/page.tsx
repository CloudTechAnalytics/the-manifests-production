...
import { LifecycleTimeline } from '@/features/shipments/components/lifecycle-timeline';
import { ShipmentWorkflowPanel } from '@/features/shipments/components/shipment-workflow-panel';
import { ShipmentDocumentsPanel } from '@/features/shipments/components/shipment-documents-panel';
import { CustomsFormDialog } from '@/features/customs/components/customs-form-dialog';
import { DutyAssessmentCard } from '@/features/customs/components/duty-assessment-card';
import { DutyAssessmentDialog } from '@/features/customs/components/duty-assessment-dialog';
import { TerminalFormDialog } from '@/features/terminal/components/terminal-form-dialog';
import { ExaminationFormDialog } from '@/features/examination/components/examination-form-dialog';
import { TransportationFormDialog } from '@/features/transportation/components/transportation-form-dialog';
import { FinancialExposurePanel } from '@/features/shipments/components/financial-exposure-panel';
import { checkShipmentStatusReadiness } from '@/shared/lib/utils/workflow-rules';
import { ShipmentDocumentationDialog } from '@/features/shipments/components/shipment-documentation-dialog';
import { ShipmentPartiesDialog } from '@/features/shipments/components/shipment-parties-dialog';
import { ShipmentContainersPanel } from '@/features/shipments/components/shipment-containers-panel';
import { CargoInsurancePanel } from '@/features/shipments/components/cargo-insurance-panel';
import { CargoClaimsPanel } from '@/features/shipments/components/cargo-claims-panel';
import { DeliveryOrdersPanel } from '@/features/shipments/components/delivery-orders-panel';
import { GenerateInvoiceFromExpenses } from '@/features/shipments/components/generate-invoice-from-expenses';
import { CustomsBondsPanel } from '@/features/customs/components/customs-bonds-panel';
import {
