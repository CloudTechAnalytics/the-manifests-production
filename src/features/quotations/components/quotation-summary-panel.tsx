...
import { QUOTATION_SERVICES, paymentTermsLabel } from '@/shared/lib/quotation-constants';
import { getSuggestions } from '@/shared/lib/quotation-rules';
import { computeQuotationTotals, computeQuotationCompleteness } from '@/shared/lib/quotation-schema';
import type { QuotationFormValues } from '@/shared/lib/quotation-schema';
import type { Customer, QuotationStatus } from '@/shared/types';
