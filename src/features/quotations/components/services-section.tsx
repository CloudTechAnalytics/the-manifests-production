...
import { QUOTATION_SERVICES } from '@/shared/lib/quotation-constants';
import { resolveChargeTemplate, resolveDefaultRate, resolveDefaultServices } from '@/shared/lib/quotation-rules';
