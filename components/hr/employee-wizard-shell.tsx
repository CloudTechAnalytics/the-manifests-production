...
import { useEmployeeWizard, type EmployeeWizardStep } from '@/lib/employee-wizard';
import { EmployeePersonalSection } from '@/components/hr/employee-personal-section';
import { EmployeeEmploymentSection, type ManagerOption } from '@/components/hr/employee-employment-section';
import { EmployeeResponsibilitiesSection } from '@/components/hr/employee-responsibilities-section';
import { EmployeeManifestAccessSection } from '@/components/hr/employee-manifest-access-section';
import { EmployeeSensitiveInfoSection } from '@/components/hr/employee-sensitive-info-section';
import { EmployeeReviewSection } from '@/components/hr/employee-review-section';
import type { Branch, Department, Profile } from '@/types';
