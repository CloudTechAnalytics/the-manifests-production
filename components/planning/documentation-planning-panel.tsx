...
import { resolveRequiredTemplates } from '@/lib/utils/document-templates';
...
import { CHECKLIST_DOCUMENT_STATUS_META, formatDate } from '@/lib/utils/status';
import type { ChecklistDocumentStatus, PlanDocumentChecklistItem } from '@/types';
